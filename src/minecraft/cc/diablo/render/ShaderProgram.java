...
public class ShaderProgram {
    ...
    private static String readShader(String fileName) {
        ...
        try {
            final InputStreamReader inputStreamReader = new InputStreamReader(ShaderProgram.class.getClassLoader().getResourceAsStream(String.format("assets/minecraft/Client/shaders/%s", fileName)));
