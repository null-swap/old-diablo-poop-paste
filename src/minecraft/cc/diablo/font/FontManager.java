    ...
    public FontManager() {
        ...
        try {
            for (int i : new int[]{16, 36, 20}) {
                InputStream istream = getClass().getResourceAsStream("/assets/minecraft/Client/fonts/Raleway-Regular.ttf");
                Font myFont = Font.createFont(Font.PLAIN, istream);
                myFont = myFont.deriveFont(Font.PLAIN, i);
                fonts.put("raleway-1 " + i, new TTFFontRenderer(executorService, textureQueue, myFont));
            }
            for (int i : new int[]{16, 36, 20}) {
            ...
            for (int i : new int[]{16, 36, 20}) {
                InputStream istream = getClass().getResourceAsStream("/assets/minecraft/Client/fonts/arial.ttf");
                Font myFont = Font.createFont(Font.PLAIN, istream);
                myFont = myFont.deriveFont(Font.PLAIN, i);
                fonts.put("arial " + i, new TTFFontRenderer(executorService, textureQueue, myFont));
            }
            for (int i : new int[]{16, 36, 20}) {
                InputStream istream = getClass().getResourceAsStream("/assets/minecraft/Client/fonts/Lato-Regular.ttf");
                Font myFont = Font.createFont(Font.PLAIN, istream);
                myFont = myFont.deriveFont(Font.PLAIN, i);
                fonts.put("lato " + i, new TTFFontRenderer(executorService, textureQueue, myFont));
            }
            for (int i : new int[]{16, 36, 20, 22, 24, 26, 28, 30, 32, 34, 38, 40, 42, 44, 46, 48}) {
                InputStream istream = getClass().getResourceAsStream("/assets/minecraft/Client/fonts/SF-UI-Display-Regular.ttf");
                Font myFont = Font.createFont(Font.PLAIN, istream);
                myFont = myFont.deriveFont(Font.PLAIN, i);
                fonts.put("sfui " + i, new TTFFontRenderer(executorService, textureQueue, myFont));
            }
            for (int i : new int[]{16, 36, 20, 22, 24, 26, 28, 30, 32, 34, 38, 40, 42, 44, 46, 48}) {
                InputStream istream = getClass().getResourceAsStream("/assets/minecraft/Client/fonts/skeetIcons.ttf");
                Font myFont = Font.createFont(Font.PLAIN, istream);
                myFont = myFont.deriveFont(Font.PLAIN, i);
                fonts.put("skeeticons " + i, new TTFFontRenderer(executorService, textureQueue, myFont));
            }
            for (int i : new int[]{16, 36, 20, 22, 24, 26, 28, 30, 32, 34, 38, 40, 42, 44, 46, 48}) {
                InputStream istream = getClass().getResourceAsStream("/assets/minecraft/Client/fonts/guiicons.ttf");
                Font myFont = Font.createFont(Font.PLAIN, istream);
                myFont = myFont.deriveFont(Font.PLAIN, i);
                fonts.put("guicons " + i, new TTFFontRenderer(executorService, textureQueue, myFont));
            }
