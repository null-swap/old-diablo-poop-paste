...
public class Block
{
    ...
    public static EnumFacing getFacingDirection(BlockPos pos) {
        ...
        MovingObjectPosition rayResult = Minecraft.theWorld.rayTraceBlocks(
                new Vec3(Minecraft.getMinecraft().thePlayer.posX, Minecraft.getMinecraft().thePlayer.posY + (double) Minecraft.getMinecraft().thePlayer.getEyeHeight(), Minecraft.getMinecraft().thePlayer.posZ),
