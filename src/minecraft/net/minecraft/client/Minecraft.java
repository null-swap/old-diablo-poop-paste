...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    protected static boolean authed = true;
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        this.createDisplay();
        Display.setTitle("Loading Diablo...");
        ...
        try{
            if(!getLatestVersion().equals(Main.version) && (!Objects.equals(Main.buildType, "Developer") && !Objects.equals(Main.buildType, "Beta"))){
                JOptionPane.showMessageDialog(null, "Your client is outdated. Please redownload the JAR from intent.store or rerun the Intent Launcher");
                Minecraft.getMinecraft().shutdown();
                System.exit(3);
            } else {
                Main.uid = "intent.store";
                Main.serverVersion = getLatestVersion();
                Main.username = "User";
    ...
    public static String getLatestVersion(){
        try{
            HttpsURLConnection connection = (HttpsURLConnection) new URL("https://intent.store/product/48/latestVersion").openConnection();
    ...
    private void drawSplashScreen(TextureManager textureManagerInstance) throws LWJGLException
    {
        ...
        try
        {
            ...
            //this.mojangLogo = new ResourceLocation("Client/images/background.png");
    ...
    private void rightClickMouse()
    {
        if (!this.playerController.func_181040_m())
        {
            ...
            if (flag)
            {
                ...
                if (itemstack1 != null && this.playerController.sendUseItem(this.thePlayer, theWorld, itemstack1))
                {
