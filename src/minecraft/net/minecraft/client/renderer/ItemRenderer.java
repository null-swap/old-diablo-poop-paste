...
import cc.diablo.module.impl.render.ItemOffset;
...
public class ItemRenderer
{
    ...
    private void transformFirstPersonItem(float equipProgress, float swingProgress)
    {
        ...
        if(ModuleManager.getModule(Animations.class).isToggled()) {
            if (mc.thePlayer.getItemInUseCount() > 0 || (KillAura.blocking && ModuleManager.getModule(KillAura.class).toggled)) {
    ...
    public void renderItemInFirstPerson(float partialTicks)
    {
        ...
        if (this.itemToRender != null)
        {
            ...
            //Animation shit
            if(ModuleManager.getModule(Animations.class).isToggled()) {
                GL11.glScalef((float) Animations.scale.getVal(), (float) Animations.scale.getVal(), (float) Animations.scale.getVal());
                //if(ItemRenderer.ItemRenderer$1.field_178094_a[enumaction.ordinal()] != 4) {
