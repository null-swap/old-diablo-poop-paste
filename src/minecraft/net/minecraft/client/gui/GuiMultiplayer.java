...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new VersionSlider(420, sr.getScaledWidth() - 205, 5, 200, 20));
        this.createButtons();
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        fr.drawString("Username: " + (mc.session.getUsername() != null ? mc.session.getUsername() : "null"), 5,5,-1);
