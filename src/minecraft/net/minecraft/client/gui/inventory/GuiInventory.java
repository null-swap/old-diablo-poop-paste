...
public class GuiInventory extends InventoryEffectRenderer
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(0, 1, 1,150,20,ChatColor.GRAY + "Disable Killaura"));
        this.buttonList.add(new GuiButton(1, 1, 22,150,20, ChatColor.GRAY + "Disable Invmanager"));
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        if (!InventoryCleaner.isChanging) {
