...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        Main.getInstance().getEventBus().post(e);
        HUD hud = new HUD();
    ...
    protected void renderTooltip(ScaledResolution sr, float partialTicks)
    {
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer)
        {
            ...
            if(HUD.customHotbar.isChecked()){

                RenderUtils.drawRect(x,y,x +width,y+height,RenderUtils.transparency(new Color(27, 27, 27).getRGB(), 0.6f));
                RenderUtils.drawRect(i - 91 + entityplayer.inventory.currentItem * 20,sr.getScaledHeight() - 1,(float) (i - 91 + entityplayer.inventory.currentItem * 20 + 22),sr.getScaledHeight(), ColorHelper.getColor( 150));
    ...
    private void renderScoreboard(ScoreObjective p_180475_1_, ScaledResolution p_180475_2_)
    {
        ...
        int k1 = 0;
        if(ModuleManager.getModule(cc.diablo.module.impl.render.Scoreboard.class).toggled && cc.diablo.module.impl.render.Scoreboard.position.isChecked()) {
            k1 = p_180475_2_.getScaledHeight() - j1 / 3;
        }else {
            k1 = p_180475_2_.getScaledHeight() / 2 + j1 / 3;
        }
        byte b0 = 3;
        ...
        for (Object score1 : arraylist1)
        {
            ...
            if(s4.contains(".com") || s4.contains(".net") || s4.contains(".org") || s4.contains(".cc") || s4.contains(".xyz") || s4.contains(".club") || s4.contains(".cn")){
            ...
            if (k == arraylist1.size())
            {
                ...
                drawRect(j - 2, l - this.getFontRenderer().FONT_HEIGHT - 2, i1, l - this.getFontRenderer().FONT_HEIGHT - 1, ColorHelper.getColor(0));
                if(ModuleManager.getModule(cc.diablo.module.impl.render.Scoreboard.class).toggled && !cc.diablo.module.impl.render.Scoreboard.clear.isChecked()) {
