...
public class GuiOverlayDebug extends Gui
{
    ...
    protected List call()
    {
        ...
        {
            return Lists.newArrayList("Minecraft 1.8.8 (" + this.mc.getVersion() + "/" + ClientBrandRetriever.getClientModName() + ")", this.mc.debug, this.mc.renderGlobal.getDebugInfoRenders(), this.mc.renderGlobal.getDebugInfoEntities(), "P: " + this.mc.effectRenderer.getStatistics() + ". T: " + Minecraft.theWorld.getDebugLoadedEntities(), Minecraft.theWorld.getProviderName(), "", String.format("Chunk-relative: %d %d %d", Integer.valueOf(blockpos.getX() & 15), Integer.valueOf(blockpos.getY() & 15), Integer.valueOf(blockpos.getZ() & 15)));
        }
        else
        {
            ...
            if (Minecraft.theWorld != null && Minecraft.theWorld.isBlockLoaded(blockpos))
            {
                ...
                arraylist.add("Biome: " + chunk.getBiome(blockpos, Minecraft.theWorld.getWorldChunkManager()).biomeName);
                ...
                arraylist.add(String.format("Local Difficulty: %.2f (Day %d)", Float.valueOf(difficultyinstance.getAdditionalDifficulty()), Long.valueOf(Minecraft.theWorld.getWorldTime() / 24000L)));
            }
